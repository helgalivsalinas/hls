...
```
cd hls
mkvirtualenv --no-site-packages hls
...
```
* * * * * ubuntu bash /home/ubuntu/apps/hls/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|hls|tweet|`location`||||
|hls|facebook|`location`||||
|hls|comments_opened|||||
|hls|comments_closed||``seconds_open``|||
|hls|comments_open_for|``seconds_open``|||
